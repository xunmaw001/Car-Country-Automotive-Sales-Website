...
<html>
	...
	<style type="text/css">
		...
		#header .nav-top {
			...
			height: 50px;
			background: linear-gradient(264deg, #ADBDD5 0%, #5D7599 100%);
			  ...
			  <div class="nav-top-tel"></div>
				...
				<div class="list">
					<ul>
						...
						<li v-if="chatFlag"><a href="javascript:chatTap()" class="menumain"><i v-if="false" class="layui-icon">&#xe677;</i>客服咨询</a></li>
					</ul>
				</div>
		    </div>
