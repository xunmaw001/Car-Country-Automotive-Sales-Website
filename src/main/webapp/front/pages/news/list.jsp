...
<html>
	...
	<body>
		...
		<div id="app">
			<!-- 轮播图 -->
			<div class="layui-carousel" id="test1" :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 auto","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid"}'>
			  <div carousel-item>
			...
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(93, 117, 153, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"16px","borderStyle":"solid"}'>
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(93, 117, 153, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>标题</div>
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(93, 117, 153, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="title" id="title" placeholder="标题" autocomplete="off" class="layui-input">
					</div>
					<button :style='{"padding":"0 15px","boxShadow":"0 0 8px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"#409EFF","backgroundColor":"rgba(93, 117, 153, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}' id="btn-search" type="button" class="layui-btn layui-btn-normal">
						<i class="layui-icon layui-icon-search"></i>搜索
												...
												<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" :style='{"padding":"24px","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 2% 10px 2%","borderColor":"rgba(93, 117, 153, 1)","backgroundColor":"#fff","borderRadius":"40px","borderWidth":"4px","width":"46%","borderStyle":"solid","height":"auto"}' class="list-item-body animation-box">
							<div class="h">
								<div class="title" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"24px","fontSize":"18px","borderStyle":"solid"}'>{{item.title}}</div>
								<div class="time" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(172, 172, 172, 1)","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.addtime}}</div>
							</div>
							<div class="desc" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(172, 172, 172, 1)","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"28px","fontSize":"14px","borderStyle":"solid"}'>{{item.introduction}}</div>
							<div class="tag" :style='{"padding":"2px 12px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(93, 117, 153, 1)","color":"#fff","borderRadius":"24px","borderWidth":"0","width":"72px","lineHeight":"24px","fontSize":"12px","borderStyle":"solid"}'>新闻动态</div>
						</div>
					</div>
