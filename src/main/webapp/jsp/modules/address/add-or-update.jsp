					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>地址管理</span></li>
								<li class="breadcrumb-item active"><span>编辑地址</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>收货人</label>
										<input name="name" id="name" name="name" class="form-control" placeholder="收货人">
									</div>
									<div class="form-group col-md-6">
										<label>电话</label>
										<input name="phone" id="phone" name="phone" class="form-control" placeholder="电话">
									</div>
									<div class="form-group col-md-6">
										<label>是否默认地址[是/否]</label>
										<input name="isdefault" id="isdefault" name="isdefault" class="form-control" placeholder="是否默认地址[是/否]">
									</div>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.isdefault != null && res.data.isdefault != ''){
						...
						$("#isdefault").attr('readonly','readonly');
					}
				}
			});  
            }
