...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210722/83687ca3f32c489180312e821a6e6c61.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		box-shadow: 0 0 6px rgba(255, 141, 141, 0.49);
	}
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="yonghuming" placeholder="用户名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="shenfenzheng" placeholder="身份证" class="form-control-i">
							</div>
