...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">购物车表管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>购物车表列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">购物车表列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('price')">单价<i id="priceIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('discountprice')">会员价<i id="discountpriceIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('goodtype')">商品类型<i id="goodtypeIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var goodtypeCell  = document.createElement('td');

						 goodtypeCell.innerHTML = item.goodtype;

			row.appendChild(goodtypeCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("cart/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"cart");
