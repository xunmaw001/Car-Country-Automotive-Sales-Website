...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑购物车表</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>购物车表管理</span></li>
								<li class="breadcrumb-item active"><span>编辑购物车表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">购物车表信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>商品表名</label>
										<input name="tablename" id="tablename" name="tablename" class="form-control" placeholder="商品表名">
									</div>
									<div class="form-group col-md-6">
										<label>商品id</label>
										<input name="goodid" id="goodid" name="goodid" class="form-control" placeholder="商品id">
									</div>
									<div class="form-group col-md-6">
										<label>商品名称</label>
									...
									<div class="form-group col-md-6">
										<label>单价</label>
										<input name="price" id="price" name="price" class="form-control" placeholder="单价">
									</div>
									<div class="form-group col-md-6">
										<label>会员价</label>
										<input name="discountprice" id="discountprice" name="discountprice" class="form-control" placeholder="会员价">
									</div>
									<div class="form-group col-md-6">
										<label>商品类型</label>
										<input name="goodtype" id="goodtype" name="goodtype" class="form-control" placeholder="商品类型">
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#goodtype").val(ruleForm.goodtype);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.goodtype != null && res.data.goodtype != ''){

						$("#goodtype").val(res.data.goodtype);
