		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑预约记录</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>预约记录管理</span></li>
								<li class="breadcrumb-item active"><span>编辑预约记录</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约记录信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>预约内容</label>
										<input name="yuyueneirong" id="yuyueneirong" name="yuyueneirong" class="form-control" placeholder="预约内容">
									</div>
									<div class="form-group col-md-6">
										<label>用户名</label>
										<input name="yonghuming" id="yonghuming" name="yonghuming" class="form-control" placeholder="用户名">
									</div>
									<div class="form-group col-md-6">
										<label>手机</label>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("yuyuejilu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yuyuejilu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuyuejilu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yuyueneirong != null && res.data.yuyueneirong != ''){
						...
						$("#yuyueneirong").attr('readonly','readonly');
					}
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#qichemingcheng").attr('readonly','readonly');
                $("#qichetupian").attr('readonly','readonly');
                $("#yonghuming").attr('readonly','readonly');
                $("#shouji").attr('readonly','readonly');
            }
		}
