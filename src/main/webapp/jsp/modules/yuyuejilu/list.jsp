...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">预约记录管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>预约记录列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约记录列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<label>预约时间</label>
									<input id="yuyueshijian_start" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
									至
									<input id="yuyueshijian_end" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                                    <label>
                                        是否通过
                                    </label>
	...
	<script>
		...
		function search(){
			...
			if($('#yuyueshijian_start').val() != null && $('#yuyueshijian_start').val() != ''){
				searchForm.yuyueshijian_start = $('#yuyueshijian_start').val();
			}
			if($('#yuyueshijian_end').val() != null && $('#yuyueshijian_end').val() != ''){
				searchForm.yuyueshijian_end = $('#yuyueshijian_end').val();
			}
        ...
        function getDataList() {
			http("yuyuejilu/page","GET",{
				...
				yuyueshijian_start : searchForm.yuyueshijian_start,
				yuyueshijian_end : searchForm.yuyueshijian_end,
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function sh(){
			...
			httpJson("yuyuejilu/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yuyuejilu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"yuyuejilu");
