						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>价格</label>
										<input name="price" id="price" name="price" class="form-control" placeholder="价格">
									</div>
									<div class="form-group col-md-6">
										<label>折扣价格</label>
									...
									<div class="form-group col-md-6">
										<label>总价格</label>
										<input name="total" id="total" name="total" class="form-control" placeholder="总价格">
									</div>
									<div class="form-group col-md-6">
										<label>折扣总价格</label>
									...
									<div class="form-group col-md-6">
										<label>备注</label>
										<input name="remark" id="remark" name="remark" class="form-control" placeholder="备注">
									</div>
									<div class="form-group col-md-6">
										<label>商品类型</label>
										<input name="goodtype" id="goodtype" name="goodtype" class="form-control" placeholder="商品类型">
											...
											<div class="form-group  col-md-12" id="logistics">
												<label>物流</label>
												<div><div class="upload"><input id="logisticsupload" name="file" type="file">插入图片</div>
